	...
	<form action="" method="post" accept-charset="utf-8">
		<table class="permalinks">
			<tr>
				...
				<td><input size="40" type="text" name="link[author_structure]" value="<?php echo esc_attr( $options['permalinks']['author_structure']); ?>"/>
					<span class="sub">default: <code><?php echo esc_html( $myrewrite->get_author_permastruct() ) ?></code></span></td>
			</tr>

			<tr>
				<th><?php _e ('Category pages', 'advanced-permalinks'); ?>:</th>
				<td><input size="40" type="text" name="link[category_structure]" value="<?php echo esc_attr( $options['permalinks']['category_structure']); ?>"/> <span class="sub">default: <code><?php echo $myrewrite->get_category_permastruct () ?></code></span></td>
			</tr>
		...
		<?php if ($this->is_25 ()) : ?>
		<p>Extra Rules:</p>
		<textarea name="extra" style="width: 95%" rows="5"><?php echo esc_html ($options['extra']); ?></textarea>
